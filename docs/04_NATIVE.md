...
> [原参考文件](https://github.com/Eien-Natsu/stsai-combat/blob/d2e1f0f1449e880af21912b17687d9527dfc49f6/docs/04_NATIVE.md)。
...
锁定引擎与 5 个顺序补丁见 [engine_lock.json](https://github.com/Eien-Natsu/stsai-combat/blob/e0fc584d19afe58ac10b65c93c7bcc75a2630f05/engine_lock.json)。[离线源码 manifest](https://github.com/Eien-Natsu/stsai-combat/blob/e0fc584d19afe58ac10b65c93c7bcc75a2630f05/native/native_sources_manifest.json)声明 PRE_PATCH 快照；复核先校验再应用补丁，不能重复应用到已打补丁的源码。
